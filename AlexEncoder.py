...
def build_model():
    ...
    # pool1
    net['enpool1'] = MaxPool2DLayer(net['enconv1'], pool_size=(3, 3), stride=2)
    ...
    net['enconv2_data1'] = SliceLayer(net['enpool1'], indices=slice(0, 48), axis=1)
    net['enconv2_data2'] = SliceLayer(net['enpool1'], indices=slice(48, 96), axis=1)

    # now do the convolutions
    net['enconv2_part1'] = Conv2DLayer(net['enconv2_data1'],
                                     num_filters=128,
                                     filter_size=(5, 5),
                                     pad=2)
    net['enconv2_part2'] = Conv2DLayer(net['enconv2_data2'],
                                     num_filters=128,
                                     filter_size=(5, 5),
                                     pad=2)

    # now combine
    net['enconv2'] = concat((net['enconv2_part1'], net['enconv2_part2']), axis=1)

    # pool2
    net['enpool2'] = MaxPool2DLayer(net['enconv2'], pool_size=(3, 3), stride=2)


    # conv3
    # no group
    net['enconv3'] = Conv2DLayer(net['enpool2'],
                               num_filters=384,
                               filter_size=(3, 3),
                               pad=1)
    ...
    # conv4
    # group = 2
    net['enconv4_data1'] = SliceLayer(net['enconv3'], indices=slice(0, 192), axis=1)
    net['enconv4_data2'] = SliceLayer(net['enconv3'], indices=slice(192, 384), axis=1)
    net['enconv4_part1'] = Conv2DLayer(net['enconv4_data1'],
                                     num_filters=192,
                                     filter_size=(3, 3),
                                     pad=1)
    net['enconv4_part2'] = Conv2DLayer(net['enconv4_data2'],
                                     num_filters=192,
                                     filter_size=(3, 3),
                                     pad=1)
    net['enconv4'] = concat((net['enconv4_part1'], net['enconv4_part2']), axis=1)

    # conv5
    # group 2
    net['enconv5_data1'] = SliceLayer(net['enconv4'], indices=slice(0, 192), axis=1)
    net['enconv5_data2'] = SliceLayer(net['enconv4'], indices=slice(192, 384), axis=1)
    net['enconv5_part1'] = Conv2DLayer(net['enconv5_data1'],
                                     num_filters=128,
                                     filter_size=(3, 3),
                                     pad=1)
    net['enconv5_part2'] = Conv2DLayer(net['enconv5_data2'],
                                     num_filters=128,
                                     filter_size=(3, 3),
                                     pad=1)
    net['enconv5'] = concat((net['enconv5_part1'], net['enconv5_part2']), axis=1)

    # pool 5
    net['enpool5'] = MaxPool2DLayer(net['enconv5'], pool_size=(3, 3), stride=2)

    net['depool5'] = Upscale2DLayer(net['enconv5'], scale_fractor=)
