...
for t in range(numavg):
    ...
    save = '/home/mharmon/ZProject/ModelResults/mnist/AdaAvg' + bndir

    figsave = save + '/Figures/'
    parname = save + '/Parameters'

    testloss,testcorrect,testpred,valloss,valcorrect,valpred,bestloss,bestperc = main(dataset,num_epochs,parname,bn)
